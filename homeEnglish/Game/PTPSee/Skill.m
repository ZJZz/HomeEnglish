...
//	CCProgressTimer *timer = [CCProgressTimer progressWithFile:@"progress.png"];
    ...
    CCSprite *tempProgress =[CCSprite spriteWithFile:@"progress.png" ];
    
    if ([SceneTo uiIpadBack]) {
        tempProgress.scale = 1*2;
    }else
        tempProgress.scale = 1;
    
    CCProgressTimer *timer = [CCProgressTimer progressWithSprite:tempProgress];
